...
namespace WebServiceCrawl
{
    ...
    public class FundaCrawler
    {
        ...
        /// </summary>
        /// <param name="objectType">An enumeration value to search for</param>
        /// <param name="searchArray">An array with all words you want to search for</param>
        /// <returns></returns>
        ...
        private async Task FillPageResultInDictionary(ObjectType objectType, string[] searchArray, int page)
        {
            ...
            var url = string.Format(UrlPattern, objectType.ToString().ToLower(), searchString, page);
